...
export default function ServerFlowExplainer({ step = 0 }) {
  return (
    <ExplainerStage kicker="BEHIND THE SCENES · 02" title="שכבת השרת — מרכז התיאום" step={step} captions={CAPTIONS}>
      ...
      <InfoCard x={300} y={425} w={440} title="מה המנהל עושה עכשיו?" show={step === 8} checklist items={[
      ...
      <InfoCard x={300} y={430} w={440} title="עכשיו — עם המחירים ביד" show={step === 11} checklist items={[
