...
export default function Slide20() {
  return (
    <section className="pslide p20" dir="ltr">
      ...
      <svg style={{ '--d': 191, '--sx': '70px' }} className="fx fx-fade p20-e23 pel" viewBox="0 0 812800 698500" preserveAspectRatio="none"><path d="M 812800 349250 L 609600 698500 L 203200 698500 L 0 349250 L 203200 0 L 609600 0 L 812800 349250 Z" fill="#396e83" /></svg>
      <div style={{ '--d': 191, '--sx': '70px' }} className="fx fx-fade p20-e24 pel">
        <div className="p20-e24-tx">
          <p className="pp" dir="auto" style={{ textAlign: 'center', fontSize: '75px' }}>{'\u00A0'}</p>
        </div>
      </div>
      <svg style={{ '--d': 191, '--sx': '70px' }} className="fx fx-fade p20-e25 pel" viewBox="0 0 2727227 1451547" preserveAspectRatio="none"><path d="M 0 0 L 2727227 0 L 2727227 1451547 L 0 1451547 Z" fill="#396e83" /></svg>
      <div style={{ '--d': 191, '--sx': '70px' }} className="fx fx-fade p20-e26 pel">
        <div className="p20-e26-tx">
          <p className="pp" dir="auto" style={{ textAlign: 'center', fontSize: '30.05px' }}>{'\u00A0'}</p>
        </div>
      </div>
      <svg style={{ '--d': 191, '--sx': '70px' }} className="fx fx-fade p20-e27 pel" viewBox="0 0 6350000 5532120" preserveAspectRatio="none"><path d="M 4762500 0 L 1587500 0 L 0 2766060 L 1587500 5532120 L 4762500 5532120 L 6350000 2766060 L 4762500 0 Z M 4676140 5382260 L 1673860 5382260 L 172720 2766060 L 1673860 149860 L 4676140 149860 L 6177280 2766060 L 4676140 5382260 Z" fill="#ffffff" /></svg>
      <div style={{ '--d': 191, '--sx': '70px' }} className="fx fx-fade p20-e28 pel"><img src={img3} alt="" /></div>
      <svg style={{ '--d': 191, '--sx': '70px' }} className="fx fx-fade p20-e29 pel" viewBox="0 0 54.34 101.14" preserveAspectRatio="none"><line x1="0" y1="0" x2="54.34" y2="101.14" stroke="#ffffff" strokeWidth="4.09" vectorEffect="non-scaling-stroke" /></svg>
      <svg style={{ '--d': 191, '--sx': '70px' }} className="fx fx-fade p20-e30 pel" viewBox="0 0 57.02 99.65" preserveAspectRatio="none"><line x1="0" y1="0" x2="57.02" y2="99.65" stroke="#ffffff" strokeWidth="4.09" vectorEffect="non-scaling-stroke" /></svg>
      <div style={{ '--d': 191, '--sx': '70px' }} className="fx fx-fade p20-e31 pel">
