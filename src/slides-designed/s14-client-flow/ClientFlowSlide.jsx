...
const TILES = [
  {
    ...
    icon: "layout",
    title: "App",
    desc: "Root container rendering entire SPA",
    d: 300,
  },
  {
    num: "2",
    ...
    desc: "Distributes global state and actions",
    d: 400,
  },
  {
    num: "3",
    icon: "page",
    title: "Pages",
    desc: "Route-specific screens with layouts",
    d: 500,
  },
  {
    num: "4",
    icon: "puzzle",
    title: "Components",
    desc: "Composable UI building puzzle pieces",
    d: 600,
  },
  null /* תא React badge */,
  {
    ...
    logo: axiosLogo,
    title: "Axios",
    desc: "HTTP client for API calls",
    d: 900,
  },
  {
    num: "6",
    icon: "gear",
    title: "Service",
    desc: "Encapsulates API and business logic",
    d: 800,
  },
  {
    num: "5",
    icon: "hook",
    title: "Hooks",
    desc: "Reusable stateful logic and testing",
    d: 700,
  },
];
        ...
        >
          ...
          <g className="fx fx-fade" style={{ "--d": 900 }}>
            ...
            <path
              className="cflow-arrow"
              d="M-5 -6 L5 0 L-5 6"
              transform="translate(572 95)"
              style={{ animationDelay: "0.45s" }}
            />
            <path
              className="cflow-arrow"
              d="M-5 -6 L5 0 L-5 6"
              transform="translate(864 95)"
            ...
            <path
              className="cflow-arrow"
              d="M5 -6 L-5 0 L5 6"
              transform="translate(864 329)"
              style={{ animationDelay: "1.8s" }}
            />
            <path
              className="cflow-arrow"
              d="M5 -6 L-5 0 L5 6"
              transform="translate(572 329)"
        ...
        <div className="cflow-grid">
          {TILES.map((t) =>
            t === null ? (
              <div
                key="react-badge"
                className="cflow-react fx fx-zoom"
                style={{ "--d": 1050 }}
              >
              ...
              <article
                key={t.num}
                className="card cflow-tile fx fx-rise"
                style={{ "--d": t.d }}
              >
