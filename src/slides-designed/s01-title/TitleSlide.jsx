...
const NET_EDGES = [
  [172, 78, 200, 66], [200, 66, 232, 74], [232, 74, 252, 96],
  [172, 78, 194, 100], [194, 100, 232, 74], [194, 100, 224, 112],
  [224, 112, 252, 96], [224, 112, 248, 130], [194, 100, 186, 128],
  [186, 128, 224, 112], [186, 128, 214, 142], [214, 142, 248, 130],
  [172, 78, 186, 128], [200, 66, 224, 112],
]

const NET_NODES = [
  [172, 78, 5], [200, 66, 6], [232, 74, 5], [252, 96, 7],
  [194, 100, 8], [224, 112, 6], [248, 130, 5], [186, 128, 6], [214, 142, 5],
]
      ...
      <div className="title-emblem fx fx-zoom" style={{ '--d': 100 }}>
        <svg viewBox="0 0 320 240" aria-label="Smart Cart logo">
          ...
          <g className="ts-cart">
            ...
            <path className="ts-grid" d="M104 54 l8 96 M144 54 l4 96 M64 86 h96 M72 120 h92" />
            {/* רגל + גלגלים */}
