    ...
    >
      <div className="sflow-wrap">
        ...
        <div className="sflow-flow" dir="ltr">
          {/* נתיב הבקשה - קדימה */}
          <div
            className="sflow-lane sflow-lane-req fx fx-slide-start"
            style={{ "--d": 260 }}
          >
            <span className="sflow-lane-label" dir="rtl">
              בקשה
            </span>
          ...
          <div className="sflow-row">
            {STATIONS.map((s, i) => (
              <article
                ...
                style={{ "--d": 340 + i * 110 }}
              >
                <span className="sflow-ghost" aria-hidden="true">
                  {s.num}
                </span>
                ...
                <p className="sflow-desc" dir="rtl">
                  {s.text}
                </p>
                {s.middleware && (
            ...
            <aside className="sflow-mongo fx fx-zoom" style={{ "--d": 890 }}>
              ...
              <span className="sflow-mongo-sub" dir="rtl">
                מסד הנתונים
              </span>
            </aside>
          </div>
          ...
          {/* נתיב התשובה - חזרה */}
          <div
            className="sflow-lane sflow-lane-res fx fx-slide-end"
            style={{ "--d": 960 }}
          >
