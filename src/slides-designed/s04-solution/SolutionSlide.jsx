...
export default function SolutionSlide() {
  return (
    <SlideFrame
      ...
      title={
        <>
          מה <span dir="ltr">Smart Cart</span>{" "}
          <span className="grad">עושה?</span>
        </>
      }
    >
        ...
        <div className="sol-panel fx fx-slide-end" style={{ "--d": 480 }}>
          <div className="sol-window">
            <div className="sol-chrome">
              ...
              <span className="sol-chrome-title" dir="ltr">
                Smart Cart
              </span>
            </div>
            ...
            <div className="sol-window-body">
              ...
              <div className="sol-bars">
                {STORES.map((s) => (
                  <div
                    key={s.name}
                    className={`sol-bar-row ${s.best ? "best" : ""}`}
                  >
                    ...
                    <div className="sol-bar-track">
                      ...
                      {s.best && (
                        <span
                          className="sol-best-badge fx fx-zoom"
                          style={{ "--d": 1250 }}
                        >
                          הכי משתלם
                        </span>
                    ...
                    <span className="sol-bar-price" dir="ltr">
                      {s.price}
                    </span>
                  </div>
                ))}
