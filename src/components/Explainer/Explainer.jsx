      ...
      <footer className="xp-footer">
        <div className="xp-dots" dir="ltr">
          {captions.map((_, i) => (
            <span
              key={i}
              className={`xp-dot ${i === step ? "on" : ""} ${i < step ? "past" : ""}`}
            />
          ))}
        </div>
...
export function HexStation({
  ...
  return (
    ...
    >
      ...
      {sub && (
        <div className="xp-hex-sub" dir="rtl">
          {sub}
        </div>
      )}
    </div>
  ...
  return (
    <>
      ...
      {lit && (
        ...
        >
          {packetLabel && (
            <span className="xp-packet-label" dir="ltr">
              {packetLabel}
            </span>
          )}
        </div>
...
export function LayerBracket({ x, y, w, label }) {
  return (
    <div className="xp-bracket" style={{ left: x, top: y, width: w }}>
      ...
      <div className="xp-bracket-label" dir="rtl">
        {label}
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      {items.map((it, i) => (
        <div
          key={i}
          className={checklist ? "xp-check" : "xp-info-line"}
          style={{ "--i": i }}
        >
          {it}
        </div>
...
export function Callout({
  ...
  return (
    <div
      className={`xp-callout xp-arrow-${arrow} ${show ? "show" : ""}`}
      style={{ left: x, top: y, width: w }}
      dir="rtl"
    >
      {children}
