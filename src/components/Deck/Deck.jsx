  ...
  return (
    <div className="deck" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
      ...
      <div className="deck-progress" dir="ltr">
        <div className="deck-progress-fill" style={{ width: `${((index + 1) / count) * 100}%` }} />
      </div>

      <div className="deck-counter" dir="ltr">
        <span className="deck-counter-now">{String(index + 1).padStart(2, '0')}</span>
      ...
      <div className="deck-brand" dir="ltr">
        <svg viewBox="0 0 24 24" aria-hidden="true">
          <path d="M3 4h2.4l2.2 11.2a1.6 1.6 0 0 0 1.6 1.3h8.6a1.6 1.6 0 0 0 1.6-1.2L21.5 8H6.1" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
      ...
      {help && (
        <div className="deck-help" onClick={() => setHelp(false)}>
          <div className="deck-help-panel" dir="rtl">
            <h3>קיצורי מקלדת</h3>
            <dl>
              <dt>→ / רווח</dt><dd>השקף הבא</dd>
              <dt>←</dt><dd>השקף הקודם</dd>
              <dt>G / Esc</dt><dd>מבט-על של כל השקפים</dd>
              <dt>F</dt><dd>מסך מלא</dd>
              <dt>Home / End</dt><dd>קפיצה להתחלה / סוף</dd>
              <dt>?</dt><dd>החלון הזה</dd>
            </dl>
          </div>
        </div>
      )}
